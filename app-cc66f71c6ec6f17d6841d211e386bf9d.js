...
new g(2,null)
function k({tag:t}){return t===y}function S(t){return t===y}let w=c
class _ extends d{static create(t=w){return new g(this.id,new _(t))}constructor(t=w){super(),this.revision=t}value(){return this.revision}dirty(){this.revision=++w}}function E(t){let e=[]
...
class L extends N{static create(t){return new g(this.id,new L(t))}constructor(t){super(),this.tag=t,this.lastUpdated=c}compute(){return Math.max(this.lastUpdated,this.tag.value())}update(t){t!==this.tag&&(this.tag=t,this.lastUpdated=w,this.invalidate())}}b(L)
...
return e.create(i)}}}}class Q{constructor(t){this._registrations={},this._registeredOptions={},this._registeredInjections={},t&&t.fallback&&(this._fallback=t.fallback)}register(t,e,s){this._registrations[t]=e,s&&(this._registeredOptions[t]=s)}registration(t){let e=this._registrations[t]
...
class ot extends M{constructor(t){super(t)}static create(t){return void 0===t?pt:null===t?ct:!0===t?dt:!1===t?mt:"number"==typeof t?new ut(t):new ht(t)}get(t){return pt}}class ht extends ot{constructor(){super(...arguments),this.lengthReference=null}get(t){if("length"===t){let t=this.lengthReference
return null===t&&(t=this.lengthReference=new ut(this.inner.length)),t}return super.get(t)}}class ut extends ot{constructor(t){super(t)}}const pt=new ut(void 0),ct=new ut(null),dt=new ut(!0),mt=new ut(!1)
class ft{constructor(t){this.inner=t,this.tag=t.tag}value(){return this.toBool(this.inner.value())}toBool(t){return!!t}}var gt
...
const yt=bt(gt.Get),vt=bt(gt.MaybeLocal)
...
s.expr(n),r?s.dynamicAttr(i,r,e):s.dynamicAttr(i,null,e)}class Nt{constructor(){var t=function(t=new Ot,e=new Tt){return t.add("if",(t,e,s,i,n)=>{if(!t||1!==t.length)throw new Error("SYNTAX ERROR: #if requires a single argument")
...
this.blocks=e,this.inlines=s}}class Ot{constructor(){this.names=a(),this.funcs=[]}add(t,e){this.funcs.push(e),this.names[t]=this.funcs.length-1}addMissing(t){this.missing=t}compile(t,e,s,i,n,r){let a=this.names[t]
if(void 0===a){(0,this.missing)(t,e,s,i,n,r)}else{(0,this.funcs[a])(e,s,i,n,r)}}}class Tt{constructor(){this.names=a(),this.funcs=[]}add(t,e){this.funcs.push(e),this.names[t]=this.funcs.length-1}addMissing(t){this.missing=t}compile(t,e){let s,i,n,r=t[1]
...
{let t=a.getCapabilities(o),s=[[wt.ClientSideStatement,kt.SetComponentAttrs,!0],...i,[wt.ClientSideStatement,kt.SetComponentAttrs,!1]],l=e.inlineBlock({statements:s,parameters:p}),h=e.template(r)
...
for(let c=0;c<i.length;c++)this.statementCompiler.compile(i[c],u)
let p=u.commit(a.heap,n.block.symbols.length)
return this.compiled=p}}class Dt{constructor(t){this.builder=t}static(t,e){let s=e[0],i=e[1],n=e[2],r=e[3],a=this.builder,l=a.resolver
...
let p=[]
this.getComponentSelf(lt.s0),p.push({symbol:0,isBlock:!1})
for(let d=0;d<u.length;d++){let e=u[d]
switch(e.charAt(0)){case"&":let s=null
if("&default"===e)s=l
else if("&inverse"===e)s=o
else{if(e!==_t)throw t()
s=i}s?(this.pushYieldableBlock(s),p.push({symbol:d+1,isBlock:!0})):(this.pushYieldableBlock(null),p.push({symbol:d+1,isBlock:!0}))
break
case"@":if(!r)break
let n=r[0],h=r[1],u=e
a&&(u=e.slice(1))
let c=n.indexOf(u);-1!==c&&(this.expr(h[c]),p.push({symbol:d+1,isBlock:!1}))}}this.pushRootScope(u.length+1,!!(l||o||i))
for(let t=p.length-1;t>=0;t--){var c=p[t]
let e=c.symbol
c.isBlock?this.setBlock(e):this.setVariable(e)}this.pushFrame(),this.invokeStatic(s),this.didRenderLayout(lt.s0),this.popFrame(),this.popScope(),this.popDynamicScope(),this.commitComponentTransaction(),this.load(lt.s0)}dynamicComponent(t,e,s,i,n,r=null){this.startLabels(),this.pushFrame(),this.returnTo("END"),this.expr(t),this.dup(),this.enter(2),this.jumpUnless("ELSE"),this.resolveDynamicComponent(this.referrer),this.pushDynamicComponentInstance(),this.invokeComponent(null,e,s,i,n,r),this.label("ELSE"),this.exit(),this.return(),this.label("END"),this.popFrame(),this.stopLabels()}isComponent(){this.push(57)}curryComponent(t,e,s,i){let n=this.referrer
...
this.push(40,e)}else this.primitive(null)}pushBlockScope(){this.push(39)}pushYieldableBlock(t){this.pushSymbolTable(t&&t.symbolTable),this.pushBlockScope(),this.pushBlock(t)}template(t){return t?this.inlineBlock(t):null}}class Pt extends Ft{pushBlock(t){t?this.pushOther(t):this.primitive(null)}resolveBlock(){this.push(38)}pushLayout(t){t?this.pushOther(t):this.primitive(null)}resolveLayout(){this.push(38)}invokeStatic(t){this.pushOther(t),this.push(38),this.pushMachine(41)}pushOther(t){this.push(10,this.other(t))}other(t){return this.constants.other(t)}}class jt{constructor(){this.base=0,this.length=0,this.stack=null,this._tag=null,this._references=null}setup(t,e,s){this.stack=t,this.base=e,this.length=s,0===s?(this._tag=y,this._references=p):(this._tag=null,this._references=null)}get tag(){let t=this._tag
return t||(t=this._tag=E(this.references)),t}at(t){let e=this.base,s=this.length,i=this.stack
return t<0||t>=s?pt:i.get(t,e)}capture(){return new Vt(this.tag,this.references)}prepend(t){let e=t.length
...
t=this._references=e.sliceArray(s,s+i)}return t}}class Vt{constructor(t,e,s=e.length){this.tag=t,this.references=e,this.length=s}static empty(){return new Vt(y,p,0)}at(t){return this.references[t]}value(){return this.references.map(this.valueOf)}get(t){let e=this.references,s=this.length
if("length"===t)return ot.create(s)
{let i=parseInt(t,10)
return i<0||i>=s?pt:e[i]}}valueOf(t){return t.value()}}class zt{constructor(){this.base=0,this.length=0,this._references=null,this._names=p,this._atNames=p}setup(t,e,s,i,n){this.stack=t,this.base=e,this.length=s,0===s?(this._references=p,this._names=p,this._atNames=p):(this._references=null,n?(this._names=i,this._atNames=null):(this._names=null,this._atNames=i))}get tag(){return E(this.references)}get names(){let t=this._names
...
return-1===n?pt:i.get(n,s)}capture(){return new Ht(this.tag,this.names,this.references)}merge(t){let e=t.length
...
for(let i=0;i<t.length;i++){s[t[i]]=e[i].value()}return s}}class Ut{constructor(){this.internalValues=null,this.internalTag=null,this.names=p,this.length=0,this.base=0}setup(t,e,s,i){this.stack=t,this.names=i,this.base=e,this.length=s,0===s?(this.internalTag=y,this.internalValues=p):(this.internalTag=null,this.internalValues=null)}get values(){let t=this.internalValues
if(!t){let e=this.base,s=this.length,i=this.stack
...
return-1===e?null:[this.values[3*e+2],this.values[3*e+1],this.values[3*e]]}}const Gt=new Ht(y,p,p),Yt=new Vt(y,p),Xt={tag:y,length:0,positional:Yt,named:Gt},Wt="CURRIED COMPONENT DEFINITION [id=6f00feb9-a0ef-4547-99ea-ac328f80acea]"
function Kt(t){return!(!t||!t[Wt])}class qt{constructor(t,e){this.inner=t,this.args=e,this[Wt]=!0}unwrap(t){t.realloc(this.offset)
let e=this
for(;;){var s=e
...
return Kt(t)?s+t.offset:s}}class Jt extends ft{static create(t){return new Jt(t)}toBool(t){return Kt(t)}}nt.add(24,t=>{let e,s=t.stack.pop(),i=t.fetchValue(lt.t0),n=s.value()
...
i.peek()&&t.goto(e),t.updateWith(new Zt(i))}}),nt.add(46,(t,{op1:e})=>{let s=t.stack.pop()
if(k(s))s.value()||t.goto(e)
else{let i=new D(s)
i.peek()||t.goto(e),t.updateWith(new Zt(i))}}),nt.add(51,t=>{let e=t.env,s=t.stack
s.push(e.toConditionalReference(s.pop()))})
class Zt extends at{constructor(t){super(),this.type="assert",this.tag=t.tag,this.cache=t}evaluate(t){let e=this.cache
e.revalidate()!==R&&t.throw()}}class Qt extends at{constructor(t,e){super(),this.target=e,this.type="jump-if-not-modified",this.tag=t,this.lastRevision=t.value()}evaluate(t){let e=this.tag,s=this.target,i=this.lastRevision
...
e=s.peek(),t.updateWith(new Zt(s))}if(k(n))s=n.value()
else{let e=new D(n)
s=e.peek(),t.updateWith(new Zt(e))}t.elements().pushRemoteElement(e,r,s)}),nt.add(34,t=>{t.elements().popRemoteElement()}),nt.add(30,t=>{let e=t.fetchValue(lt.t0)
...
i&&t.push(i)}return 0===t.length?null:t.join(" ")}}function pe(t){return 0|(t.dynamicLayout?1:0)|(t.dynamicTag?2:0)|(t.prepareArgs?4:0)|(t.createArgs?8:0)|(t.attributeHook?16:0)|(t.elementHook?32:0)}function ce(t,e){return!!(t&e)}const de=new class{constructor(){this.stack=null,this.positional=new jt,this.named=new zt,this.blocks=new Ut}setup(t,e,s,i,n){this.stack=t
let r=this.named,a=e.length,l=t.sp-a+1
r.setup(t,l,a,e,n)
let o=l-i
this.positional.setup(t,o,i)
let h=this.blocks,u=s.length,p=o-3*u
h.setup(t,p,u,s)}get tag(){return E([this.positional,this.named])}get base(){return this.blocks.base}get length(){return this.positional.length+this.named.length+3*this.blocks.length}at(t){return this.positional.at(t)}realloc(t){if(t>0){let e=this.positional,s=this.named,i=this.stack,n=e.base+t
...
e.push(Jt.create(s))}),nt.add(58,(t,{op1:e})=>{let s=t.stack,i=s.pop(),n=s.pop(),r=t.constants.getSerializable(e),a=t.constants.resolver
...
let i=null
return Kt(s)?i=s:"string"==typeof s&&s&&(i=ie(this.resolver,s,this.meta)),i=this.curry(i),this.lastValue=s,this.lastDefinition=i,i}get(){return pt}curry(t){let e=this.args
return!e&&Kt(t)?t:t?new qt(t,e):null}}(i,a,r,n))}),nt.add(59,(t,{op1:e})=>{let s=t.constants.resolveHandle(e),i=s.manager,n={definition:s,manager:i,capabilities:pe(i.getCapabilities(s.state)),state:null,handle:null,table:null}
...
Kt(n)?s=e=null:e=pe((s=n.manager).getCapabilities(n.state)),i.push({definition:n,capabilities:e,manager:s,state:null,handle:null,table:null})}),nt.add(61,(e,{op1:s})=>{let i,n=e.stack,r=n.pop().value()
if(!Kt(r))throw t()
...
return t.manager=n,t.capabilities=pe(n.getCapabilities(r)),i}(i,r,n))
var a=r
let l=a.manager,o=a.state
if(!0!==ce(i.capabilities,4))return void s.push(n)
let h=n.blocks.values,u=n.blocks.names,p=l.prepareArgs(o,n)
if(p){n.clear()
for(let n=0;n<h.length;n++)s.push(h[n])
let t=p.positional,e=p.named,i=t.length
...
ce(n.capabilities=pe(a.getCapabilities(r.state)),8)&&(o=t.stack.peek())
...
let i=s.definition,n=s.state,r=i.manager
t.stack.push(r.getTagName(n))}),nt.add(72,(e,{op1:s})=>{let i,n=e.fetchValue(s),r=n.manager,a=n.definition,l=e.constants.resolver,o=e.stack,h=n.state,u=n.capabilities,p=a.state
if(!1===ce(u,1))i=r.getLayout(p,l)
else{if(!function(t,e){return!0===ce(t,1)}(u))throw t()
i=r.getDynamicLayout(h,l)}o.push(i.symbolTable),o.push(i.handle)}),nt.add(56,(t,{op1:e})=>{let s=t.stack.pop(),i=t.stack.pop(),n=s.manager,r={definition:s,manager:n,capabilities:pe(n.getCapabilities(s.state)),state:null,handle:i.handle,table:i.symbolTable}
...
for(let t=u.length-1;t>=0;t--){let e=u[t],s=l.indexOf(u[t]),n=r.named.get(e,!1);-1!==s&&i.bindSymbol(s+1,n),o&&(h[e]=n)}let p=(t,e)=>{let s=l.indexOf(t),n=c.get(e);-1!==s&&i.bindBlock(s+1,n),h&&(h[t]=n)},c=r.blocks
p(_t,"attrs"),p("&inverse","else"),p("&default","main"),h&&i.bindEvalScope(h),t.call(n)}}),nt.add(78,(t,{op1:e})=>{var s=t.fetchValue(e)
...
let c=p.symbolTable,d=p.handle
{let e=c.symbols,s=t.scope(),i=t.pushRootScope(e.length,!1),n=s.getEvalScope()
...
class fe{constructor(t,e){this.element=t,this.nextSibling=e}}class ge{constructor(t,e,s){this.parentNode=t,this.first=e,this.last=s}parentElement(){return this.parentNode}firstNode(){return this.first}lastNode(){return this.last}}class be{constructor(t,e){this.parentNode=t,this.node=e}parentElement(){return this.parentNode}firstNode(){return this.node}lastNode(){return this.node}}function ye(t,e){return new be(t,e)}function ve(t,e){let s=t.parentElement(),i=t.firstNode(),n=t.lastNode(),r=i
...
let a=r[0],l=r[1]
return new ge(t,a,l)}(t,i,n,e)}}}function _e(t,e){return t&&function(t){let e=t.createElement("div")
...
if(null===i||""===i)return new ge(r,null,null)
...
return new ge(r,o,n)}(this.uselessElement,t,e,s)}createTextNode(t){return this.document.createTextNode(t)}createComment(t){return this.document.createComment(t)}}var Oe;(function(t){class e extends Ne{createElementNS(t,e){return this.document.createElementNS(t,e)}setAttribute(t,e,s,i=null){i?t.setAttributeNS(i,e,s):t.setAttribute(e,s)}}t.TreeConstruction=e
let s=e
s=_e(Ae,s),s=we(Ae,s,Ee),t.DOMTreeConstruction=s})(Oe||(Oe={}))
let Te=class extends Ne{constructor(t){super(t),this.document=t,this.namespace=null}setAttribute(t,e,s){t.setAttribute(e,s)}removeAttribute(t,e){t.removeAttribute(e)}insertAfter(t,e,s){this.insertBefore(t,e,s.nextSibling)}}
Te=_e(Ae,Te)
var Le=Te=we(Ae,Te,Ee)
const Be=Oe.DOMTreeConstruction,De=["javascript:","vbscript:"],Re=["A","BODY","LINK","IMG","IFRAME","BASE","FORM"],Me=["EMBED"],Ie=["href","src","background","action"],Fe=["src"]
...
return"attr"===n?Ye(s,r):function(t,e){if(ze(t,e))return qe
if(function(t,e){return("INPUT"===t||"TEXTAREA"===t)&&"value"===e}(t,e))return Ze
if(function(t,e){return"OPTION"===t&&"selected"===e}(t,e))return Qe
return Ke}(s,r)}function Ye(t,e){return ze(t,e)?Je:We}class Xe{constructor(t){this.attribute=t}}class We extends Xe{set(t,e,s){let i=ts(e)
...
i?e.removeAttributeNS(i,s):e.removeAttribute(s)}}class qe extends Ke{set(t,e,s){var i=this.attribute
let n=He(s,i.element,i.name,e)
super.set(t,n,s)}update(t,e){var s=this.attribute
let i=He(e,s.element,s.name,t)
super.update(i,e)}}class Je extends We{set(t,e,s){var i=this.attribute
let n=He(s,i.element,i.name,e)
super.set(t,n,s)}update(t,e){var s=this.attribute
let i=He(e,s.element,s.name,t)
super.update(i,e)}}class Ze extends Ke{set(t,e){t.__setProperty("value",ne(e))}update(t){let e=this.attribute.element,s=e.value,i=ne(t)
s!==i&&(e.value=i)}}class Qe extends Ke{set(t,e){null!==e&&void 0!==e&&!1!==e&&t.__setProperty("selected",!0)}update(t){let e=this.attribute.element
...
if(e){let s=function(t,e,s){return new ge(t,e,s)}(this.element,e,t.lastChild)
...
if(t&&t.length)for(let e=0;e<t.length;e++)t[e].destroy()}parentElement(){return this.parent}firstNode(){return this.first&&this.first.firstNode()}lastNode(){return this.last&&this.last.lastNode()}openElement(t){this.didAppendNode(t),this.nesting++}closeElement(){this.nesting--}didAppendNode(t){0===this.nesting&&(this.first||(this.first=new ps(t)),this.last=new cs(t))}didAppendBounds(t){0===this.nesting&&(this.first||(this.first=t),this.last=t)}newDestroyable(t){this.destroyables=this.destroyables||[],this.destroyables.push(t)}finalize(t){this.first||t.appendComment("")}}class fs extends ms{destroy(){super.destroy(),ke(this)}}class gs extends ms{reset(t){let e=this.destroyables
...
let u=r.vmForInsertion(l),p=null,c=r.start
u.execute(c,i=>{n[t]=p=i.iterate(s,e),i.updatingOpcodeStack.push(new h),i.updateWith(p),i.updatingOpcodeStack.push(p.children)}),a.insertBefore(p,o),this.didInsert=!0}retain(t,e,s){}move(t,e,s,i){let n=this.map,r=this.updating,a=n[t],l=n[i]||null
ve(a,i?l.firstNode():this.marker),r.remove(a),r.insertBefore(a,l)}delete(t){let e=this.map,s=e[t]
s.didDestroy(),ke(s),this.updating.remove(s),delete e[t],this.didDelete=!0}done(){this.opcode.didInitializeChildren(this.didInsert||this.didDelete)}}class Ns extends Cs{constructor(t,e,s,i,n){super(t,e,s,i),this.type="list-block",this.map=a(),this.lastIterated=c,this.artifacts=n
...
return Ls.resume(s,i)}}class Os{constructor(t,e){this.ops=t,this.exceptionHandler=e,this.current=t.head()}goto(t){this.current=t}nextStatement(){let t=this.current,e=this.ops
return t&&(this.current=e.nextNode(t)),t}handleException(){this.exceptionHandler&&this.exceptionHandler.handleException()}}class Ts{constructor(t,e,s,i){this.env=t,this.program=e,this.updating=s,this.bounds=i}rerender({alwaysRevalidate:t=!1}={alwaysRevalidate:!1}){let e=this.env,s=this.program,i=this.updating
...
return null!==r?(this.inner.evaluateOuter(r,this),t={done:!1,value:null}):(this.stack.reset(),t={done:!0,value:new Ts(e,s,i.pop(),n.popBlock())}),t}bindDynamicScope(t){let e=this.dynamicScope()
...
return this.position++,{key:n,value:i,memo:r}}}class qs{constructor(t,e,s){this.position=0,this.keys=t,this.values=e,this.keyFor=s}isEmpty(){return 0===this.keys.length}next(){let t=this.position,e=this.keys,s=this.values,i=this.keyFor
if(t>=e.length)return null
...
class Zs{constructor(t,e){this.tag=t.tag,this.ref=t,this.keyFor=e}iterate(){let t=this.ref,e=this.keyFor,s=t.value()
if(Array.isArray(s))return s.length>0?new Ks(s,e):Js
if(void 0===s||null===s)return Js
if(void 0!==s.forEach){let t=[]
return s.forEach(function(e){t.push(e)}),t.length>0?new Ks(t,e):Js}if("object"==typeof s){let t=Object.keys(s)
return t.length>0?new qs(t,t.map(t=>s[t]),e):Js}throw new Error(`Don't know how to {{#each ${s}}}`)}valueReferenceFor(t){return new Hs(t.value)}updateValueReference(t,e){t.update(e.value)}memoReferenceFor(t){return new Hs(t.memo)}updateMemoReference(t,e){t.update(e.memo)}}class Qs extends is{static create(t={}){return t.document=t.document||self.document,t.appendOperations=t.appendOperations||new Be(t.document),new Qs(t)}constructor(t){super({appendOperations:t.appendOperations,updateOperations:new Le(t.document||document)}),st(this,et(t)),this.uselessAnchor=t.document.createElement("a")}protocolForURL(t){return this.uselessAnchor.href=t,this.uselessAnchor.protocol}iterableFor(t,e){let s
if(!e)throw new Error("Must specify a key for #each")
switch(e){case"@index":s=((t,e)=>String(e))
break
case"@primitive":s=(t=>String(t))
break
default:s=(t=>t[e])}return new Zs(t,s)}}const ti="object"==typeof document?document:null
...
i.push({id:this._rootsIndex++,component:t,parent:e,nextSibling:s}),n&&(n.update({roots:i}),this.scheduleRerender())}async boot(){this.initialize(),this.env=this.lookup(`environment:/${this.rootName}/main/main`),await this._render()}scheduleRerender(){!this._scheduled&&this._rendered&&(this._rendering=!0,this._scheduled=!0,setTimeout(()=>{this._scheduled=!1,this._rerender(),this._rendering=!1},0))}initialize(){this.initRegistry(),this.initContainer()}registerInitializer(t){this._initializers.push(t)}initRegistry(){let t=this._registry=new Q,e=new Xs(this._registry,this.resolver)
t.register(`environment:/${this.rootName}/main/main`,Qs),t.registerOption("helper","instantiate",!1),t.registerOption("template","instantiate",!1),t.register(`document:/${this.rootName}/main/main`,this.document),t.registerOption("document","instantiate",!1),t.registerInjection("environment","document",`document:/${this.rootName}/main/main`),t.registerInjection("component-manager","env",`environment:/${this.rootName}/main/main`)
...
return this.resolve(s)}registerHelper(t,e){return this.register("helper",t,(t,s)=>new ii(e,s))}registerInternalHelper(t,e){this.register("helper",t,e)}registerComponent(t,e,s,i){let n=this.registerTemplate(e,i),r=this.managerFor(n.meta.managerId),a=new J(t,r,s,n.handle)
...
return e>-1?e:this.serializables.push(t)-1}getSerializable(t){return this.serializables[t]}getOther(t){return this.others[t-1]}other(t){return this.others.push(t)}}class pi{constructor(t){this.heap=t,this.offset=0}get size(){return 1+((768&this.heap.getbyaddr(this.offset))>>8)}get isMachine(){return 1024&this.heap.getbyaddr(this.offset)}get type(){return 255&this.heap.getbyaddr(this.offset)}get op1(){return this.heap.getbyaddr(this.offset+1)}get op2(){return this.heap.getbyaddr(this.offset+2)}get op3(){return this.heap.getbyaddr(this.offset+3)}}function ci(t,e,s){return t|e<<16|s<<30}function di(t,e){return t|e<<30}class mi{constructor(t){if(this.placeholders=[],this.offset=0,this.handle=0,t){let e=t.buffer,s=t.table,i=t.handle
...
return{handle:this.handle,table:this.table,buffer:t}}}class fi{constructor(t=new oi,e=new mi){this.constants=t,this.heap=e,this._opcode=new pi(this.heap)}opcode(t){return this._opcode.offset=t,this._opcode}}class gi extends fi{}var bi={id:"j7SGa6Pm",block:'{"symbols":["root"],"statements":[[4,"each",[[22,["roots"]]],[["key"],["id"]],{"statements":[[4,"in-element",[[21,1,["parent"]]],[["guid","nextSibling"],["%cursor:0%",[21,1,["nextSibling"]]]],{"statements":[[1,[26,"component",[[21,1,["component"]]],null],false]],"parameters":[]},null]],"parameters":[1]},null]],"hasEval":false}',meta:{specifier:"template:/-application/application/src/templates/main"}}
...
return{compile:()=>s.handle,symbolTable:s.symbolTable}}lookupHelper(t,e){return this.resolver.lookupHelper(t,e)}lookupModifier(t,e){return this.resolver.lookupModifier(t,e)}lookupComponentDefinition(t,e){return this.resolver.lookupComponentHandle(t,e)}lookupPartial(t,e){return this.resolver.lookupPartial(t,e)}}class Si{constructor(t){this.resolver=t}async getTemplateIterator(t,e,s,n,r){let a=new ni(t),l={program:new gi(new ui(a)),macros:new Nt,resolver:new ki(a),Builder:Pt}
...
if(this.registry.has(e))return e}}class Oi{constructor(t={}){this._entries=t}has(t){return t in this._entries}get(t){return this._entries[t]}}var Ti=function(t,e,s,i){var n,r=arguments.length,a=r<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,s):i
...
class Li extends K{constructor(){super(...arguments),this.hover=!1}get style(){const t=1.3*this.args.size
return isNaN(this.args.y)&&console.log(`dot ${this.args.x} ${this.args.y}`),`\n      width: ${t}px;\n      height: ${t}px;\n      left: ${this.args.x}px;\n      top: ${this.args.y}px;\n      border-radius: ${t/2}px;\n      line-height: ${t}px;\n      background: ${this.hover?"#ff0":"#61dafb"}\n    `}enter(){this.hover=!0}leave(){this.hover=!1}}Ti([V],Li.prototype,"hover",void 0),Ti([V("hover")],Li.prototype,"style",null)
var Bi=function(t,e,s,i){var n,r=arguments.length,a=r<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,s):i
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,s,i)
else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(a=(r<3?n(a):r>3?n(e,s,a):n(e,s))||a)
return r>3&&a&&Object.defineProperty(e,s,a),a}
class Di extends K{constructor(){super(...arguments),this.seconds=0,this.intervalId=-1,this.elapsed=0,this.start=Date.now()}didInsertElement(){this.intervalId=setInterval(this.tick.bind(this),1e3),this.tickElapsed()}tickElapsed(){this.elapsed=Date.now()-this.start,requestAnimationFrame(this.tickElapsed.bind(this))}tick(){this.seconds=this.seconds%10+1}get style(){const t=this.elapsed/1e3%10
return`transform: ${"scaleX("+(1+(t>5?10-t:t)/10)/2.1+") scaleY(0.7) translateZ(0.1px)"}`}}Bi([V],Di.prototype,"seconds",void 0),Bi([V],Di.prototype,"elapsed",void 0),Bi([V("elapsed")],Di.prototype,"style",null)
var Ri={"component:/my-app/components/Dot":Li,"template:/my-app/components/Dot":{id:"xkJdV7Se",block:'{"symbols":["&default"],"statements":[[6,"div"],[10,"class","dotStyle"],[11,"style",[20,"style"],null],[11,"onmouseenter",[26,"action",[[22,["enter"]]],null],null],[11,"onmouseleave",[26,"action",[[22,["leave"]]],null],null],[8],[0,"\\n"],[4,"if",[[22,["hover"]]],null,{"statements":[[0,"    *"],[13,1],[0,"*\\n"]],"parameters":[]},{"statements":[[0,"    "],[13,1],[0,"\\n"]],"parameters":[]}],[9]],"hasEval":false}',meta:{specifier:"template:/my-app/components/Dot"}},"component:/my-app/components/MyApp":Di,"template:/my-app/components/MyApp":{id:"mH5sheiE",block:'{"symbols":[],"statements":[[6,"h1"],[8],[0,"Glimmer Example "],[6,"small"],[8],[6,"a"],[10,"title","source"],[10,"href","https://github.com/makepanic/sierpinski-glimmer/"],[8],[0,"🔗"],[9],[9],[9],[0,"\\n"],[6,"div"],[10,"id","container"],[8],[0,"\\n  Naive dummy app that renders a "],[6,"a"],[10,"href","https://en.wikipedia.org/wiki/Sierpinski_triangle"],[8],[0,"Sierpinski triangle"],[9],[0," as a simple \\"benchmark\\"."],[6,"br"],[8],[9],[0,"\\n  Created out of curiosity on how glimmer compares to "],[6,"a"],[10,"href","https://medium.com/@marcisbee/how-i-built-super-fast-js-framework-faster-than-react-ea99f0d03150"],[8],[0,"other implementations"],[9],[0,"."],[6,"br"],[8],[9],[0,"\\n  "],[6,"small"],[8],[0,"This is a quick implementation and has some implementation differences."],[9],[0,"\\n"],[9],[0,"\\n\\n"],[6,"div"],[10,"class","containerStyle"],[11,"style",[20,"style"],null],[8],[0,"\\n  "],[5,"SierpinskiTriangle",[],[["@x","@y","@s"],[0,0,1000]],{"statements":[[1,[20,"seconds"],false]],"parameters":[]}],[0,"\\n"],[9]],"hasEval":false}',meta:{specifier:"template:/my-app/components/MyApp"}},"component:/my-app/components/SierpinskiTriangle":class extends K{},"template:/my-app/components/SierpinskiTriangle":{id:"oT8Acmet",block:'{"symbols":["s","@x","@y","&default","@s"],"statements":[[4,"if",[[26,"lte",[[21,5,[]],25],null]],null,{"statements":[[0,"  "],[5,"Dot",[],[["@x","@y","@size"],[[26,"sub",[[21,2,[]],12.5],null],[26,"sub",[[21,3,[]],12.5],null],"25"]],{"statements":[[13,4]],"parameters":[]}],[0,"\\n"]],"parameters":[]},{"statements":[[4,"with",[[26,"div",[[21,5,[]],2],null]],null,{"statements":[[0,"    "],[6,"div"],[8],[0,"\\n      "],[5,"SierpinskiTriangle",[],[["@x","@y","@s"],[[21,2,[]],[26,"sub",[[21,3,[]],[26,"div",[[21,1,[]],2],null]],null],[21,1,[]]]],{"statements":[[13,4]],"parameters":[]}],[0,"\\n      "],[5,"SierpinskiTriangle",[],[["@x","@y","@s"],[[26,"sub",[[21,2,[]],[21,1,[]]],null],[26,"add",[[21,3,[]],[26,"div",[[21,1,[]],2],null]],null],[21,1,[]]]],{"statements":[[13,4]],"parameters":[]}],[0,"\\n      "],[5,"SierpinskiTriangle",[],[["@x","@y","@s"],[[26,"add",[[21,2,[]],[21,1,[]]],null],[26,"add",[[21,3,[]],[26,"div",[[21,1,[]],2],null]],null],[21,1,[]]]],{"statements":[[13,4]],"parameters":[]}],[0,"\\n    "],[9],[0,"\\n"]],"parameters":[1]},null]],"parameters":[]}]],"hasEval":false}',meta:{specifier:"template:/my-app/components/SierpinskiTriangle"}},"helper:/my-app/components/add":function([t,e]){return t+e},"helper:/my-app/components/div":function([t,e]){const s=t/e
return isNaN(s),s},"helper:/my-app/components/lte":function([t,e]){return t<=e},"helper:/my-app/components/sub":function([t,e]){let s=t-e
return isNaN(s),s}},Mi={app:{name:"my-app",rootName:"my-app"},types:{application:{definitiveCollection:"main"},component:{definitiveCollection:"components"},"component-test":{unresolvable:!0},helper:{definitiveCollection:"components"},"helper-test":{unresolvable:!0},renderer:{definitiveCollection:"main"},template:{definitiveCollection:"components"}},collections:{main:{types:["application","renderer"]},components:{group:"ui",types:["component","component-test","template","helper","helper-test"],defaultType:"component",privateCollections:["utils"]},styles:{group:"ui",unresolvable:!0},utils:{unresolvable:!0}}}
const Ii=new class extends ei{constructor(){let t=new Oi(Ri),e=new Ni(Mi,t)
const s=document.body
super({builder:new wi({element:s,nextSibling:null}),loader:new Si(e),renderer:new _i,resolver:e,rootName:Mi.app.rootName})}},Fi=document.getElementById("app")
Y=(()=>{Ii.scheduleRerender()}),Ii.registerInitializer({initialize(t){t.register(`component-manager:/${Ii.rootName}/component-managers/main`,Gs)}}),Ii.renderComponent("MyApp",Fi,null),Ii.boot()})
